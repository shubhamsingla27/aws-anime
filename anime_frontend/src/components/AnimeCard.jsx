    ...
    >
      ...
      <ActionModal open={open} onClose={() => setOpen(false)}>
        <div className="text-center w-56">
          <AiOutlineDelete size={56} className="mx-auto text-red-500" />
          ...
          <div className="flex gap-4">
            <button onClick={onDelete} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded w-full">Delete</button>
            <button
